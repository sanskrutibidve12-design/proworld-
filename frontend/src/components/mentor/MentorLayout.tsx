...
export default function MentorLayout({ children }: any) {
  ...
  const basePath = mentorType === "industry" ? "/mentor/industry" : "/mentor/college";

  const navItems = mentorType === "industry"
    ? [
        { label: "Dashboard", path: `${basePath}/dashboard` },
        { label: "Students", path: `${basePath}/students` },
        { label: "Attendance", path: `${basePath}/attendance` },
        { label: "Updates", path: `${basePath}/updates` },
        { label: "Tasks", path: `${basePath}/tasks` },
        { label: "Remarks", path: `${basePath}/remarks` },
      ]
    : [
        { label: "Dashboard", path: `${basePath}/dashboard` },
        { label: "Students", path: `${basePath}/students` },
          ...
          <div className="w-64 h-full bg-[#0a0f1e] text-white flex flex-col">
            <div className="px-6 py-5 flex items-center gap-3 border-b border-white/5">
              ...
              <div>
                ...
                <p className="text-[10px] text-blue-400/80 tracking-widest uppercase">Mentor Panel</p>
              </div>
            </div>
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 group ${
                      active ? "bg-blue-600 text-white shadow-lg shadow-blue-500/20" : "text-white/60 hover:bg-white/5 hover:text-white"
                    }`}
                  >
